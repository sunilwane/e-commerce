...
// import productdata from "../image/book4.json";
import booklistdata from "../image/book4.json";
    ...
    <div className="" style={{ marginTop: "5%" }}>
      ...
      <div className="cardpayment">
        <div className="partimg">
          <img src={booklistdata[id].images.medium.url} alt="" />
          <h3>Price- {booklistdata[id].price * count}</h3>
          <h4> {booklistdata[id].label}</h4>
        </div>
